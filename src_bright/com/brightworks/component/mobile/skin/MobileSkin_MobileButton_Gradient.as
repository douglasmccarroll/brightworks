package com.brightworks.component.mobile.skin {
   ...
   public class MobileSkin_MobileButton_Gradient extends MobileSkin {
      ...
      private var _styleName:String = ".mobileButton_Gradient";
      ...
      public function MobileSkin_MobileButton_Gradient() {
         super();
      ...
      override protected function createChildren():void {
         ...
         if (!styleDec) {
            Log.error("MobileSkin_MobileButton_Gradient.createChildren(): No CSS for styleName of '" + _styleName + "'");
            return;
         }
      ...
      private function drawBackgroundRect():void {
         ...
         switch (currentState) {
            ...
            default:  {
               Log.error("MobileSkin_MobileButton_Gradient.drawBackground(): No case for current state of '" + currentState + "' - using default");
